    ...
    <section
      className={clsx(
        ...
        headerVariant !== 'high-contrast' &&
          styles['remove-high-contrast-header']
      )}>
      {!navigationHide && (
        <nav
          ...
          <InternalButton
            ariaLabel={ariaLabels?.navigationToggle ?? void 0}
      ...
      {breadcrumbs && (
        <div
          className={clsx(
            styles['mobile-toolbar-breadcrumbs'],
        ...
        !toolsHide && (
          <aside
            ...
            <InternalButton
              ...
              disabled={hasDrawerViewportOverlay}
              ariaLabel={ariaLabels?.toolsToggle ?? void 0}
